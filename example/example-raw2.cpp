...
public:
    ...
    inline QSequentialIterableImpl &advance(int i) {
      ((i > 0 || _iteratorCapabilities & BiDirectionalCapability) ? static_cast<void>(0) : qt_assert("i > 0 || _iteratorCapabilities & BiDirectionalCapability", "/usr/local/include/QtCore/qmetatype.h", 1205));
    ...
    int size() const { ((_iterable) ? static_cast<void>(0) : qt_assert("_iterable", "/usr/local/include/QtCore/qmetatype.h", 1220)); return _size(_iterable); }
...
public:
    ...
    int size() const { ((_iterable) ? static_cast<void>(0) : qt_assert("_iterable", "/usr/local/include/QtCore/qmetatype.h", 1395)); return _size(_iterable); }
...
)
{
    ...
    ((normalizedTypeName == QMetaObject::normalizedType(normalizedTypeName.constData())) ? static_cast<void>(0) : qt_assert_x("qRegisterNormalizedMetaType", "qRegisterNormalizedMetaType was called with a not normalized type name, please call qRegisterMetaType instead.", "/usr/local/include/QtCore/qmetatype.h", 1855));
...
namespace w_internal { template<> struct W_TypeRegistery<char*> { enum { registered = true }; static constexpr auto name = viewLiteral("char*"); };}
namespace w_internal { template<> struct W_TypeRegistery<const char*> { enum { registered = true }; static constexpr auto name = viewLiteral("const char*"); };}
...
public:
    ...
    inline void setSharable(bool sharable)
    {
        ...
        ((d->ref.isSharable() == sharable) ? static_cast<void>(0) : qt_assert("d->ref.isSharable() == sharable", "/usr/local/include/QtCore/qvector.h", 128));
    }
    ...
    inline void removeFirst() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 153)); erase(d->begin()); }
    inline void removeLast();
    T takeFirst() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 155)); T r = std::move(first()); removeFirst(); return r; }
    T takeLast() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 156)); T r = std::move(last()); removeLast(); return r; }
    ...
    {
        ((from >= 0 && from < size()) ? static_cast<void>(0) : qt_assert_x("QVector::move(int,int)", "'from' is out-of-range", "/usr/local/include/QtCore/qvector.h", 192));
        ((to >= 0 && to < size()) ? static_cast<void>(0) : qt_assert_x("QVector::move(int,int)", "'to' is out-of-range", "/usr/local/include/QtCore/qvector.h", 193));
        if (from == to)
            return;
        detach();
        T * const b = d->begin();
    ...
    inline T& first() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 242)); return *begin(); }
    inline const T &first() const { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 243)); return *begin(); }
    inline const T &constFirst() const { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 244)); return *begin(); }
    inline T& last() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 245)); return *(end()-1); }
    inline const T &last() const { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 246)); return *(end()-1); }
    inline const T &constLast() const { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 247)); return *(end()-1); }
    ...
    void swapItemsAt(int i, int j) {
        ((i >= 0 && i < size() && j >= 0 && j < size()) ? static_cast<void>(0) : qt_assert_x("QVector<T>::swap", "index out of range", "/usr/local/include/QtCore/qvector.h", 257));
    ...
    __attribute__ ((__deprecated__("Use QVector<T>(vector.begin(), vector.end()) instead.")))
    static inline QVector<T> fromStdVector(const std::vector<T> &vector)
    { return QVector<T>(vector.begin(), vector.end()); }
    __attribute__ ((__deprecated__("Use std::vector<T>(vector.begin(), vector.end()) instead.")))
...
void QVector<T>::detach()
{
    ...
    ((isDetached()) ? static_cast<void>(0) : qt_assert("isDetached()", "/usr/local/include/QtCore/qvector.h", 413));
}
...
void QVector<T>::reserve(int asize)
{
    ...
    ((capacity() >= asize) ? static_cast<void>(0) : qt_assert("capacity() >= asize", "/usr/local/include/QtCore/qvector.h", 427));
}
...
{ ((i >= 0 && i < d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::at", "index out of range", "/usr/local/include/QtCore/qvector.h", 455));
  return d->begin()[i]; }
template <typename T>
inline const T &QVector<T>::operator[](int i) const
{ ((i >= 0 && i < d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::operator[]", "index out of range", "/usr/local/include/QtCore/qvector.h", 459));
  return d->begin()[i]; }
template <typename T>
inline T &QVector<T>::operator[](int i)
{ ((i >= 0 && i < d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::operator[]", "index out of range", "/usr/local/include/QtCore/qvector.h", 463));
  return data()[i]; }
template <typename T>
inline void QVector<T>::insert(int i, const T &t)
{ ((i >= 0 && i <= d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::insert", "index out of range", "/usr/local/include/QtCore/qvector.h", 467));
  insert(begin() + i, 1, t); }
template <typename T>
inline void QVector<T>::insert(int i, int n, const T &t)
{ ((i >= 0 && i <= d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::insert", "index out of range", "/usr/local/include/QtCore/qvector.h", 471));
  insert(begin() + i, n, t); }
template <typename T>
inline void QVector<T>::insert(int i, T &&t)
{ ((i >= 0 && i <= d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::insert", "index out of range", "/usr/local/include/QtCore/qvector.h", 475));
  insert(begin() + i, std::move(t)); }
template <typename T>
inline void QVector<T>::remove(int i, int n)
{ ((i >= 0 && n >= 0 && i + n <= d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::remove", "index out of range", "/usr/local/include/QtCore/qvector.h", 479));
  erase(d->begin() + i, d->begin() + i + n); }
template <typename T>
inline void QVector<T>::remove(int i)
{ ((i >= 0 && i < d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::remove", "index out of range", "/usr/local/include/QtCore/qvector.h", 483));
...
{
    ((i >= 0 && i < d->size) ? static_cast<void>(0) : qt_assert_x("QVector<T>::replace", "index out of range", "/usr/local/include/QtCore/qvector.h", 495));
    const T copy(t);
    data()[i] = copy;
}
...
{
    ((asize >= 0) ? static_cast<void>(0) : qt_assert_x("QVector::QVector", "Size must be greater than or equal to 0.", "/usr/local/include/QtCore/qvector.h", 513));
...
{
    ((asize >= 0) ? static_cast<void>(0) : qt_assert_x("QVector::QVector", "Size must be greater than or equal to 0.", "/usr/local/include/QtCore/qvector.h", 527));
    if (asize > 0) {
        d = Data::allocate(asize);
        do { if (!(d)) qBadAlloc(); } while (false);
        d->size = asize;
...
{
    ((asize >= 0 && asize <= aalloc) ? static_cast<void>(0) : qt_assert("asize >= 0 && asize <= aalloc", "/usr/local/include/QtCore/qvector.h", 596));
    Data *x = d;
    ...
    if (aalloc != 0) {
        if (aalloc != int(d->alloc) || isShared) {
            try {
                ...
                ((x->ref.isSharable() || options.testFlag(QArrayData::Unsharable)) ? static_cast<void>(0) : qt_assert("x->ref.isSharable() || options.testFlag(QArrayData::Unsharable)", "/usr/local/include/QtCore/qvector.h", 609));

                ((!x->ref.isStatic()) ? static_cast<void>(0) : qt_assert("!x->ref.isStatic()", "/usr/local/include/QtCore/qvector.h", 611));
                x->size = asize;
            ...
            ((int(d->alloc) == aalloc) ? static_cast<void>(0) : qt_assert("int(d->alloc) == aalloc", "/usr/local/include/QtCore/qvector.h", 663));
            ((isDetached()) ? static_cast<void>(0) : qt_assert("isDetached()", "/usr/local/include/QtCore/qvector.h", 664));
            ((x == d) ? static_cast<void>(0) : qt_assert("x == d", "/usr/local/include/QtCore/qvector.h", 665));
            if (asize <= d->size) {
    ...
    ((d->data()) ? static_cast<void>(0) : qt_assert("d->data()", "/usr/local/include/QtCore/qvector.h", 689));
    ((uint(d->size) <= d->alloc) ? static_cast<void>(0) : qt_assert("uint(d->size) <= d->alloc", "/usr/local/include/QtCore/qvector.h", 690));

    ((d != Data::unsharableEmpty()) ? static_cast<void>(0) : qt_assert("d != Data::unsharableEmpty()", "/usr/local/include/QtCore/qvector.h", 692));

    ((aalloc ? d != Data::sharedNull() : d == Data::sharedNull()) ? static_cast<void>(0) : qt_assert("aalloc ? d != Data::sharedNull() : d == Data::sharedNull()", "/usr/local/include/QtCore/qvector.h", 694));
    ((d->alloc >= uint(aalloc)) ? static_cast<void>(0) : qt_assert("d->alloc >= uint(aalloc)", "/usr/local/include/QtCore/qvector.h", 695));
    ((d->size == asize) ? static_cast<void>(0) : qt_assert("d->size == asize", "/usr/local/include/QtCore/qvector.h", 696));
}

template<typename T>
void QVector<T>::realloc(int aalloc, QArrayData::AllocationOptions options)
{
    ((aalloc >= d->size) ? static_cast<void>(0) : qt_assert("aalloc >= d->size", "/usr/local/include/QtCore/qvector.h", 702));
    Data *x = d;
    ...
    try {
        ...
        ((x->ref.isSharable() || options.testFlag(QArrayData::Unsharable)) ? static_cast<void>(0) : qt_assert("x->ref.isSharable() || options.testFlag(QArrayData::Unsharable)", "/usr/local/include/QtCore/qvector.h", 713));

        ((!x->ref.isStatic()) ? static_cast<void>(0) : qt_assert("!x->ref.isStatic()", "/usr/local/include/QtCore/qvector.h", 715));
        x->size = d->size;
    ...
    ((d != x) ? static_cast<void>(0) : qt_assert("d != x", "/usr/local/include/QtCore/qvector.h", 748));
    if (!d->ref.deref()) {
        if (!QTypeInfoQuery<T>::isRelocatable || !aalloc || (isShared && QTypeInfo<T>::isComplex)) {
    ...
    ((d->data()) ? static_cast<void>(0) : qt_assert("d->data()", "/usr/local/include/QtCore/qvector.h", 760));
    ((uint(d->size) <= d->alloc) ? static_cast<void>(0) : qt_assert("uint(d->size) <= d->alloc", "/usr/local/include/QtCore/qvector.h", 761));

    ((d != Data::unsharableEmpty()) ? static_cast<void>(0) : qt_assert("d != Data::unsharableEmpty()", "/usr/local/include/QtCore/qvector.h", 763));

    ((d != Data::sharedNull()) ? static_cast<void>(0) : qt_assert("d != Data::sharedNull()", "/usr/local/include/QtCore/qvector.h", 765));
    ((d->alloc >= uint(aalloc)) ? static_cast<void>(0) : qt_assert("d->alloc >= uint(aalloc)", "/usr/local/include/QtCore/qvector.h", 766));
}
...
{
    ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qvector.h", 827));
    ((d->alloc) ? static_cast<void>(0) : qt_assert("d->alloc", "/usr/local/include/QtCore/qvector.h", 828));
...
{
    ((isValidIterator(before)) ? static_cast<void>(0) : qt_assert_x("QVector::insert", "The specified iterator argument 'before' is invalid", "/usr/local/include/QtCore/qvector.h", 840));
...
{
    ((isValidIterator(before)) ? static_cast<void>(0) : qt_assert_x("QVector::insert", "The specified iterator argument 'before' is invalid", "/usr/local/include/QtCore/qvector.h", 875));
...
{
    ((isValidIterator(abegin)) ? static_cast<void>(0) : qt_assert_x("QVector::erase", "The specified iterator argument 'abegin' is invalid", "/usr/local/include/QtCore/qvector.h", 905));
    ((isValidIterator(aend)) ? static_cast<void>(0) : qt_assert_x("QVector::erase", "The specified iterator argument 'aend' is invalid", "/usr/local/include/QtCore/qvector.h", 906));
    ...
    ((abegin >= d->begin()) ? static_cast<void>(0) : qt_assert("abegin >= d->begin()", "/usr/local/include/QtCore/qvector.h", 913));
    ((aend <= d->end()) ? static_cast<void>(0) : qt_assert("aend <= d->end()", "/usr/local/include/QtCore/qvector.h", 914));
    ((abegin <= aend) ? static_cast<void>(0) : qt_assert("abegin <= aend", "/usr/local/include/QtCore/qvector.h", 915));
...
public:
    ...
    __attribute__ ((__deprecated__("Use QList<T>::swapItemsAt()")))
    ...
    inline T& first() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qlist.h", 361)); return *begin(); }
    inline const T& constFirst() const { return first(); }
    inline const T& first() const { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qlist.h", 363)); return at(0); }
    T& last() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qlist.h", 364)); return *(--end()); }
    const T& last() const { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qlist.h", 365)); return at(count() - 1); }
    inline const T& constLast() const { return last(); }
    inline void removeFirst() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qlist.h", 367)); erase(begin()); }
    inline void removeLast() { ((!isEmpty()) ? static_cast<void>(0) : qt_assert("!isEmpty()", "/usr/local/include/QtCore/qlist.h", 368)); erase(--end()); }
    inline bool startsWith(const T &t) const { return !isEmpty() && first() == t; }
    inline bool endsWith(const T &t) const { return !isEmpty() && last() == t; }
    ...
    __attribute__ ((__deprecated__("Use QList<T>(set.begin(), set.end()) instead.")))
    static QList<T> fromSet(const QSet<T> &set);
    __attribute__ ((__deprecated__("Use QSet<T>(list.begin(), list.end()) instead.")))
    QSet<T> toSet() const;

    __attribute__ ((__deprecated__("Use QList<T>(list.begin(), list.end()) instead.")))
    static inline QList<T> fromStdList(const std::list<T> &list)
    { return QList<T>(list.begin(), list.end()); }
    __attribute__ ((__deprecated__("Use std::list<T>(list.begin(), list.end()) instead.")))
...
{
    ((isValidIterator(before)) ? static_cast<void>(0) : qt_assert_x("QList::insert", "The specified iterator argument 'before' is invalid", "/usr/local/include/QtCore/qlist.h", 541));
...
{
    ((isValidIterator(it)) ? static_cast<void>(0) : qt_assert_x("QList::erase", "The specified iterator argument 'it' is invalid", "/usr/local/include/QtCore/qlist.h", 560));
    if (d->ref.isShared()) {
...
{ ((i >= 0 && i < p.size()) ? static_cast<void>(0) : qt_assert_x("QList<T>::at", "index out of range", "/usr/local/include/QtCore/qlist.h", 571));
 return reinterpret_cast<Node *>(p.at(i))->t(); }
template <typename T>
inline const T &QList<T>::operator[](int i) const
{ ((i >= 0 && i < p.size()) ? static_cast<void>(0) : qt_assert_x("QList<T>::operator[]", "index out of range", "/usr/local/include/QtCore/qlist.h", 575));
 return reinterpret_cast<Node *>(p.at(i))->t(); }
template <typename T>
inline T &QList<T>::operator[](int i)
{ ((i >= 0 && i < p.size()) ? static_cast<void>(0) : qt_assert_x("QList<T>::operator[]", "index out of range", "/usr/local/include/QtCore/qlist.h", 579));
...
inline void QList<T>::removeAt(int i)
{
    ...
    if (i < 0 || i >= p.size()) {
        ...
        QMessageLogger(static_cast<const char *>("/usr/local/include/QtCore/qlist.h"), 589, static_cast<const char *>(__PRETTY_FUNCTION__)).warning("QList::removeAt(): Index out of range.");
...
{ ((i >= 0 && i < p.size()) ? static_cast<void>(0) : qt_assert_x("QList<T>::take", "index out of range", "/usr/local/include/QtCore/qlist.h", 598));
...
inline void QList<T>::insert(int i, const T &t)
{
    ...
    if (i < 0 || i > p.size())
        QMessageLogger(static_cast<const char *>("/usr/local/include/QtCore/qlist.h"), 694, static_cast<const char *>(__PRETTY_FUNCTION__)).warning("QList::insert(): Index out of range.");
...
{
    ((i >= 0 && i < p.size()) ? static_cast<void>(0) : qt_assert_x("QList<T>::replace", "index out of range", "/usr/local/include/QtCore/qlist.h", 730));
    detach();
...
{
    ((i >= 0 && i < p.size() && j >= 0 && j < p.size()) ? static_cast<void>(0) : qt_assert_x("QList<T>::swap", "index out of range", "/usr/local/include/QtCore/qlist.h", 739));
...
{
    ((from >= 0 && from < p.size() && to >= 0 && to < p.size()) ? static_cast<void>(0) : qt_assert_x("QList<T>::move", "index out of range", "/usr/local/include/QtCore/qlist.h", 748));
...
{
    ((isValidIterator(afirst)) ? static_cast<void>(0) : qt_assert_x("QList::erase", "The specified iterator argument 'afirst' is invalid", "/usr/local/include/QtCore/qlist.h", 974));
    ((isValidIterator(alast)) ? static_cast<void>(0) : qt_assert_x("QList::erase", "The specified iterator argument 'alast' is invalid", "/usr/local/include/QtCore/qlist.h", 975));
...
public:
    ...
    {
        ((d) ? static_cast<void>(0) : qt_assert("d", "/usr/local/include/QtCore/qscopedpointer.h", 112));
        return *d;
    }
...
public:
    ...
    template<typename T>
    __attribute__ ((__deprecated__("Use findChildren(const QRegularExpression &, ...) instead.")))
                                  ...
                                  const QObject *receiver, void **zero)
    {
        ...
        ((!zero) ? static_cast<void>(0) : qt_assert("!zero", "/usr/local//include/QtCore/qobject.h", 390));
        typedef QtPrivate::FunctionPointer<Func1> SignalType;
    ...
    __attribute__ ((__deprecated__("Use setProperty()")))
    void setUserData(uint id, QObjectUserData* data);
    __attribute__ ((__deprecated__("Use property()")))
...
public:
    ...
    {
        QMessageLogger(static_cast<const char *>("./example.h"),
                       40,
    ...
    friend constexpr auto w_state(
        w_internal::Index<w_internal::stateCount<0, w_internal::SlotStateTag, W_ThisType**>>,

        w_internal::SlotStateTag, W_ThisType**)
            -> decltype(
                w_internal::makeMetaSlotInfo(&W_ThisType::mySlot,
                                              w_internal::viewLiteral("mySlot"),
        ...
        {
            return w_internal::makeMetaSlotInfo( &W_ThisType::mySlot,
                                                    w_internal::viewLiteral("mySlot"),
                                                    std::integral_constant<decltype((&W_ThisType::mySlot)), &W_ThisType::mySlot>(),
                                                    w_internal::viewParsedLiterals<w_internal::countParsedLiterals("" "")>("" ""),
                                                    w_internal::W_EmptyFlag);
        }
    
    static inline void w_GetAccessSpecifierHelper(std::integral_constant<decltype(&W_ThisType::mySlot), &W_ThisType::mySlot>)
    {
    }
...
public:

    {
        ...
        return w_internal::SignalImplementation<w_SignalType, w_signalIndex_mySignal_53>{this}(name , 0);
    }
    
    static constexpr int w_signalIndex_mySignal_53 = w_internal::stateCount<1, w_internal::SignalStateTag, W_ThisType**>;

    friend constexpr auto w_state(
        w_internal::Index<w_signalIndex_mySignal_53>,
        w_internal::SignalStateTag, W_ThisType**) ->
            decltype(w_internal::makeMetaSignalInfo(
                &W_ThisType::mySignal,
                w_internal::viewLiteral("mySignal"),
                std::integral_constant<decltype((&W_ThisType::mySignal)),
                &W_ThisType::mySignal>(),
                w_internal::viewParsedLiterals<w_internal::countParsedLiterals("" "")>("" ""),
                w_internal::viewParsedLiterals<w_internal::countParsedLiterals("" "name , 0")>("" "name , 0")))
    {
    ...
    static inline void w_GetAccessSpecifierHelper(std::integral_constant<decltype((&W_ThisType::mySignal)), &W_ThisType::mySignal>)
    {
...
private:
    ...
    constexpr void process(Func, Index<Idx>, std::enable_if_t<!std::is_same<T, typename QtPrivate::FunctionPointer<Func>::Object>::value, int> = 0) {
        ...
        static_assert(signalIndex >= 0, "NOTIFY signal in parent class not registered as a W_SIGNAL");
        static_assert(signalIndex < 0 || ((5<<16)|(15<<8)|(0)) >= ((5<<16)|(10<<8)|(0)),
...
struct EnumGenerator {
    ...
    constexpr void operator() (const Enum& e, Index) {
        ...
        if (Enum::hasAlias) s.addString(e.alias);
...
constexpr void generateDataPass(State& state) {
    ...
    constexpr int constructorOffset = enumOffset + ObjI::enumCount * (((5<<16)|(15<<8)|(0)) >= ((5<<16)|(12<<8)|(0)) ? 5 : 4);
    ...
    state.addInts(((5<<16)|(15<<8)|(0)) >= ((5<<16)|(12<<8)|(0)) ? 8 : 7);
    state.addString(ObjI::name);
    state.addStringUntracked(viewLiteral(""));
    state.addInts(
        ObjI::classInfoCount, classInfoOffset,
        ObjI::methodCount, methodOffset,
        ObjI::propertyCount, propertyOffset,
        ObjI::enumCount, enumOffset,
        ObjI::constructorCount, constructorOffset,
        0x4 ,
        ObjI::signalCount);
...
struct MetaDataProvider {
    ...
    struct Arrays {
        ...
        constexpr static qptrdiff stringOffset = __builtin_offsetof(MetaDataType, stringChars);
...
typename MetaDataBuilder<T, index_sequence<Is...>>::MetaDataType MetaDataBuilder<T, index_sequence<Is...>>::meta_data = {
    {{ { { -1 } }, P::arrays.stringLengths[Is], 0, 0, P::arrays.stringOffsets[Is] }...},
...
inline auto propSet(F f, O *o, const T &t) -> decltype(((o->*f)(t),0)) { return ((o->*f)(t),0); }
template <typename F, typename O, typename T>
inline auto propSet(F f, O *o, const T &t) -> decltype(o->*f = t) { return o->*f = t; }
template <typename O, typename T>
inline void propSet(Empty, O *, const T &) {}

template <typename F, typename O, typename T>
inline auto propGet(F f, O *o, T &t) -> decltype(t = (o->*f)()) { return t = (o->*f)(); }
template <typename F, typename O, typename T>
inline auto propGet(F f, O *o, T &t) -> decltype(t = o->*f) { return t = o->*f; }
template <typename O, typename T>
...
inline auto propNotify(F f, M m, O *o) -> decltype(((o->*f)(o->*m),0)) { return ((o->*f)(o->*m),0); }
template <typename F, typename M, typename O>
inline auto propNotify(F f, M, O *o) -> decltype(((o->*f)(),0)) { return ((o->*f)(),0); }
template <typename... T>
inline void propNotify(T...) {}

template <typename F, typename O>
inline auto propReset(F f, O *o) -> decltype(((o->*f)(),0)) { return ((o->*f)(),0); }
template <typename... T>
...
struct FriendHelper {
 ...
 template <typename T, int I>
    ...
    static void qt_static_metacall_impl2(QObject *_o, QMetaObject::Call _c, int _id, void** _a,
        ...
        (void)_id; (void)_o; (void)_a;
        if (_c == QMetaObject::InvokeMetaMethod) {
            ((T::staticMetaObject.cast(_o)) ? static_cast<void>(0) : qt_assert("T::staticMetaObject.cast(_o)", "./verdigris/wobjectimpl.h", 964));
    ...
    static void qt_static_metacall_impl2(T *_o, QMetaObject::Call _c, int _id, void** _a,
        ...
        if (_c == QMetaObject::InvokeMetaMethod) {
            ...
            ((false) ? static_cast<void>(0) : qt_assert_x("qt_static_metacall", "IndexOfMethod called on a Q_GADGET", "./verdigris/wobjectimpl.h", 1018));
        } else if (_c == QMetaObject::CreateInstance) {
 ...
 struct MyObject::W_MetaObjectCreatorHelper { struct Name { static constexpr auto defaultName = w_internal::viewLiteral("MyObject"); static constexpr auto value = w_internal::fetchExplicitName<typename MyObject::W_ThisType>(defaultName, 0); }; using ObjectInfo = w_internal::ObjectInfo<typename MyObject::W_ThisType, Name>; }; const QMetaObject MyObject::staticMetaObject = w_internal::FriendHelper::createMetaObject<typename MyObject::W_ThisType>(); void MyObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void** _a) { w_internal::FriendHelper::qt_static_metacall_impl<MyObject>(_o, _c, _id, _a); } const QMetaObject *MyObject::metaObject() const { return &staticMetaObject; } void *MyObject::qt_metacast(const char *_clname) { return w_internal::FriendHelper::qt_metacast_impl<MyObject>(this, _clname); } int MyObject::qt_metacall(QMetaObject::Call _c, int _id, void** _a) { return w_internal::FriendHelper::qt_metacall_impl<MyObject>(this, _c, _id, _a); }
...
void aaa(MyObject *obj1) {
    ...
    ok = ok && QObject::connect(obj1, qFlagLocation("2""mySignal(QString)" "\0" "example.cpp" ":" "18"), obj1, qFlagLocation("1""mySlot(QString)" "\0" "example.cpp" ":" "18"));
